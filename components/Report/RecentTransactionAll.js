    ...
    const fetchData = async () => {
      try {
        const response = await axios.get(
          `https://ehouseapi20230817222213.azurewebsites.net/api/Contract/GetContractsByLessorIdAndStutasLessorId?id=${id}&StatusLessorId=True`,
          {
            headers: {
              Authorization: token,
            },
            ...
            <Table className="table table-bordernone m-0">
              <thead>
                <tr>
                  ...
                  <th className="light-font">Chi tiết nhà</th>
                  ...
                  contractData.map((item, i) => {
                    ...
                    return (
                      <tr key={i}>
                        ...
                        <td>{datePart}</td>
                        <td>
                          <span className={`label badge-light-success`}>
